...
for i,orf in enumerate(orfs):
    ...
    aggs.append(ingestion.aggregate_by_perturbation(chunk, group_by = ["TF", "batch", "phase"]))

anndata.concat(aggs).write_h5ad("../not_ready/GSE217460_210322_TFAtlas_aggregated.h5ad")